...
public class AtualizacaoProfessorController {
    ...
    @FXML
    void initialize() {
        assert bt_Sair != null : "fx:id=\"bt_Sair\" was not injected: check your FXML file 'AtualizacoesProfessor.fxml'.";
        assert bt_alunos_geral != null : "fx:id=\"bt_alunos_geral\" was not injected: check your FXML file 'AtualizacoesProfessor.fxml'.";
        assert bt_devolutivas_geral != null : "fx:id=\"bt_devolutivas_geral\" was not injected: check your FXML file 'AtualizacoesProfessor.fxml'.";
        assert bt_perfil_geral != null : "fx:id=\"bt_perfil_geral\" was not injected: check your FXML file 'AtualizacoesProfessor.fxml'.";
        assert bt_tela_inicial != null : "fx:id=\"bt_tela_inical\" was not injected: check your FXML file 'AtualizacoesProfessor.fxml'.";
