...
public class TGAlunoController {
    ...
    @FXML
    void initialize() {
        assert bt_Sair != null : "fx:id=\"bt_Sair\" was not injected: check your FXML file 'TGAluno.fxml'.";
        assert bt_perfil_geral != null : "fx:id=\"bt_perfil_geral\" was not injected: check your FXML file 'TGAluno.fxml'.";
        assert bt_secao_geral != null : "fx:id=\"bt_secao_geral\" was not injected: check your FXML file 'TGAluno.fxml'.";
        assert bt_tela_inicial != null : "fx:id=\"bt_tela_inicial\" was not injected: check your FXML file 'TGAluno.fxml'.";
        assert bt_tg_geral != null : "fx:id=\"bt_tg_geral\" was not injected: check your FXML file 'TGAluno.fxml'.";
